...
class Gaussian(Base):
    ...
    def __init__(self, N=1000, a=None, b=None, c=None, d=None, xlim=None, rand=True, rand_factor=0.02, seed=None):
        super().__init__(N=N,
                         xlim=xlim,
                         rand=rand,
    ...
    def set_variables(self, a, b, c, d):
        ...
        if self.xlim is None:
            n = 10
            self.xlim = (self.b - 4*self.c, self.b + 4*self.c)
...
class Normal(Gaussian):
    ...
    def __init__(self, N=1000, mu=None, sigma=None, xlim=(-2,2), rand=True, rand_factor=0.02, seed=None):
