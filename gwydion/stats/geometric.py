...
class Geometric(DiscreteProbDist):
    """
    ...
    >>>> Geometric(rand=None)  # Turn off randomness.
    >>>> Geometric(seed=1234)  # Seeded RNG.
    """


    def __init__(self, N=100, p=None, xlim=None, rand=0.01, seed=None, allow_negative_y=True):
        super().__init__(N=N,
                         xlim=xlim,
                         rand=rand,
                         seed=seed,
